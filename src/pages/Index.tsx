    ...
    <div className="min-h-screen flex flex-col bg-stone-50">
      <div className="container max-w-5xl mx-auto px-4">
        ...
        <main className="flex-grow">
          ...
          <section className="min-h-[90vh] flex flex-col justify-center items-center py-16 md:py-24">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex justify-center mb-16">
                <PrimaryButton size="lg" onClick={scrollToNextSection} className="shadow-lg hover:shadow-xl transition-all">
          ...
          {/* Why It Matters */}
          <section className="py-20 md:py-28 bg-earth-50 rounded-lg">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-semibold mb-10 text-center text-earth-700 relative">
                <span className="inline-block relative">
                  Why It Matters
          ...
          <section className="py-20 md:py-28 border-t border-stone-200">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm text-stone-700 relative max-w-2xl mx-auto">
          ...
          <section className="py-20 md:py-28 text-center border-t border-stone-200">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="flex flex-col items-center">
                ...
                <PrimaryButton size="lg" asChild className="shadow-lg hover:shadow-xl transition-all">
